...
test("Vector constructor should create a 4x1 vector object whose valueOf array is filled with the x,y,z,w values.", () => {
  ...
  expect(vecA.valueOf()[0]).toBe(1);
  expect(vecA.valueOf()[1]).toBe(2);
  expect(vecA.valueOf()[2]).toBe(3);
  expect(vecA.valueOf()[3]).toBe(0);
  expect(vecB.valueOf()).toBeDefined();
  expect(vecB).toBeInstanceOf(Vector);
  expect(vecB.valueOf()[0]).toBeCloseTo(0.1, 5);
  expect(vecB.valueOf()[1]).toBeCloseTo(0.2, 5);
  expect(vecB.valueOf()[2]).toBeCloseTo(0.3, 5);
  expect(vecB.valueOf()[3]).toBeCloseTo(1.0, 5);
});
...
test("Vector should have a sub(other) method which subtracts the given vector by an other vector.", () => {
  ...
  expect(vecR.y).toBeCloseTo(-0.3, 5);
  expect(vecR.z).toBeCloseTo(-0.3, 5);
  expect(vecR.w).toBeCloseTo(-1.0, 5);
});
...
test("Vector should have a mul(other) method which multiplicates the given vector by a scalar.", () => {
  ...
  vecR = vecB.mul(scalarB);
  expect(vecR).toBeInstanceOf(Vector);
  expect(vecR.x).toBeCloseTo(1.2, 5);
  expect(vecR.y).toBeCloseTo(1.5, 5);
  expect(vecR.z).toBeCloseTo(1.8, 5);
  expect(vecR.w).toBeCloseTo(0.3, 5);
  ...
  expect(vecR.z).toBeCloseTo(0.9, 5);
  expect(vecR.w).toBeCloseTo(0.0, 5);
  vecR = vecD.mul(scalarB);
  expect(vecR).toBeInstanceOf(Vector);
  expect(vecR.x).toBeCloseTo(0.12, 5);
  expect(vecR.y).toBeCloseTo(0.15, 5);
  expect(vecR.z).toBeCloseTo(0.18, 5);
  expect(vecR.w).toBeCloseTo(0.3, 5);
});
...
test("Vector should have a div(other) method which divides the given vector by a scalar.", () => {
  ...
  vecR = vecB.div(scalarB);
  expect(vecR).toBeInstanceOf(Vector);
  expect(vecR.x).toBeCloseTo(13.333333, 5);
  expect(vecR.y).toBeCloseTo(16.666666, 5);
  expect(vecR.z).toBeCloseTo(20.0, 5);
  expect(vecR.w).toBeCloseTo(3.3333333, 5);
  ...
  expect(vecR.w).toBeCloseTo(0.0, 5);
  vecR = vecD.div(scalarB);
  expect(vecR).toBeInstanceOf(Vector);
  expect(vecR.x).toBeCloseTo(1.333333, 5);
  expect(vecR.y).toBeCloseTo(1.666666, 5);
  expect(vecR.z).toBeCloseTo(2.0, 5);
  expect(vecR.w).toBeCloseTo(3.333333, 5);
});
...
test("Vector should have a dot(other) method which calculates the dot product of the given vector and an other vector.", () => {
  ...
  const vecC = new Vector(0.1, 0.2, 0.3, 0.0);
  const vecD = new Vector(0.4, 0.5, 0.6, 1.0);
  let scalarR = vecA.dot(vecB);
  expect(scalarR).toBe(32);
  scalarR = vecB.dot(vecA);
  expect(scalarR).toBe(32);
  scalarR = vecA.dot(vecC);
  expect(scalarR).toBe(1.4);
  scalarR = vecC.dot(vecD);
  expect(scalarR).toBe(0.32);
});
...
test("Vector should have a cross(other) method which calculates the cross product of the given vector and an other vector.", () => {
  ...
  const vecC = new Vector(0.1, 0.2, 0.3, 0.0);
  const vecD = new Vector(0.4, 0.5, 0.6, 1.0);
  let vecR = vecA.cross(vecB);
  expect(vecR).toBeInstanceOf(Vector);
  expect(vecR.x).toBe(-3);
  expect(vecR.y).toBe(6);
  expect(vecR.z).toBe(-3);
  expect(vecR.w).toBe(0);
  vecR = vecB.cross(vecA);
  expect(vecR).toBeInstanceOf(Vector);
  expect(vecR.x).toBe(3);
  expect(vecR.y).toBe(-6);
  expect(vecR.z).toBe(3);
  expect(vecR.w).toBe(0);
  vecR = vecA.cross(vecC);
  expect(vecR).toBeInstanceOf(Vector);
  expect(vecR.x).toBeCloseTo(0.0, 5);
  expect(vecR.y).toBeCloseTo(0.0, 5);
  expect(vecR.z).toBeCloseTo(0.0, 5);
  expect(vecR.w).toBeCloseTo(0.0, 5);
  vecR = vecC.cross(vecD);
  expect(vecR).toBeInstanceOf(Vector);
  expect(vecR.x).toBeCloseTo(-0.03, 5);
  expect(vecR.y).toBeCloseTo(0.06, 5);
  expect(vecR.z).toBeCloseTo(-0.03, 5);
  expect(vecR.w).toBeCloseTo(0.0, 5);
});
...
test("Vector should have a normalised() method which normalises a vector.", () => {
  ...
  expect(vecR.w).toBeCloseTo(0.0, 5);
  vecR = vecD.normalised();
  expect(vecR).toBeInstanceOf(Vector);
  expect(vecR.x).toBeCloseTo(0.455842, 5);
  expect(vecR.y).toBeCloseTo(0.569802, 5);
  expect(vecR.z).toBeCloseTo(0.683763, 5);
  expect(vecR.w).toBeCloseTo(1.0, 5);
});
...
test("Vector should have a length() method which returns the length of an vector as scalar.", () => {
  ...
  expect(vecB.length).toBeCloseTo(8.774964, 5);
  expect(vecC.length).toBeCloseTo(0.374165, 5);
  expect(vecD.length).toBeCloseTo(0.877496, 5);
});
